...
public class RelOptRulesTest extends RelOptTestBase {
  ...
  @Test public void testManyFiltersOnTopOfMultiJoinShouldCollapse() throws Exception {
    HepProgram program = new HepProgramBuilder().addMatchOrder(HepMatchOrder.BOTTOM_UP)
        .addRuleInstance(JoinToMultiJoinRule.INSTANCE)
        .addRuleCollection(
  ...
  @Test public void testCustomDecorrelate() {
    ...
    RelNode logicalDecorrelated = RelDecorrelator.decorrelateQuery(root.rel, relBuilder, false);
    RelNode customDecorrelated = RelDecorrelator.decorrelateQuery(newRoot, relBuilder, false);
