  ...
  @Test public void testStreamToRelationJoin() {
    CalciteAssert.model(STREAM_JOINS_MODEL)
        ...
        .convertContains("LogicalDelta\n"
            ...
            + "        LogicalProject(ROWTIME=[$0], ID=[$1], PRODUCT=[$2], UNITS=[$3], PRODUCT0=[CAST($2):VARCHAR(32) CHARACTER SET \"UTF-8\" COLLATE \"UTF-8$en_US$primary\" NOT NULL])\n"
        ...
        .explainContains(""
            ...
            + "    EnumerableCalc(expr#0..3=[{inputs}], expr#4=[CAST($t2):VARCHAR(32) CHARACTER SET \"UTF-8\" COLLATE \"UTF-8$en_US$primary\" NOT NULL], proj#0..4=[{exprs}])\n"
            + "      EnumerableInterpreter\n"
