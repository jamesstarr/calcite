...
public class RelBuilder {
  ...
  public RelBuilder join(JoinRelType joinType, RexNode condition,
    ...
    if (checkIfCorrelated(joinType, condition, left.rel, right.rel,
        variablesSet)) {
      ...
      case INNER:
        ...
        if(!RelOptUtil.isVariablesUsed(id, condition)) {
      ...
      case ANTI:
        ...
        if (RelOptUtil.isVariablesUsed(shifter.rightId, shiftedCondition)) {
  ...
  private static boolean checkIfCorrelated(JoinRelType joinType, RexNode condition,
    ...
    if (variablesSet.isEmpty()) {
      ...
      throw new IllegalArgumentException("Only one correlate id is supported for joins");
    }
    ...
    default:
      return !RelOptUtil.correlationColumns(id, rightRel).isEmpty()
          || RelOptUtil.isVariablesUsed(id, condition);
    }
  }
