 ...
 * plugin mechanism.
 */
public class JanioRelMetadataQuery extends RelMetadataQueryBase implements RelMetadataQuery {
  private static final JanioRelMetadataQuery EMPTY = new JanioRelMetadataQuery(false);
  ...
  private JanioRelMetadataQuery(JaninoRelMetadataProvider metadataProvider,
      JanioRelMetadataQuery prototype) {
   ...
   * determined
   */
  @Override public /* @Nullable: CALCITE-4263 */ Double getRowCount(RelNode rel) {
    for (;;) {
      try {
   ...
   */
  @Override public @Nullable Set<RelTableRef> getTableReferences(RelNode rel) {
    for (;;) {
      try {
   ...
   *
   */
  @Override public @Nullable Double getPopulationSize(RelNode rel,
   ...
   */
  @Override public @Nullable Double getDistinctRowCount(
      RelNode rel,
      ImmutableBitSet groupKey,
