...
public class JaninoMetadataHandlerProvider implements MetadataHandlerProvider {
  ...
  private static final ThreadLocal<RelMetadataProvider> METADATA_PROVIDER_THREAD_LOCAL =
      new ThreadLocal<>();
  ...
  H initialHandler(MetadataDef<M> metadataDef) {
  ...
  @Override public <H extends MetadataHandler<M>, M extends Metadata> H revise(
    ...
    return JaninoRelMetadataProvider.revise(provider, metadataDef);
  }
...
// End JaninoMetadataHandlerProvider.java
